...
const filters: { label: string; value: ProjectCategory | "SEMUA" }[] = [
  { label: "SEMUA", value: "SEMUA" },
  { label: "KEAMANAN WEB", value: "Keamanan Web" },
  { label: "KEAMANAN SIBER", value: "Keamanan Siber" },
  { label: "RISET KEAMANAN", value: "Riset Keamanan" },
  { label: "PENGEMBANGAN", value: "Pengembangan" },
];

const statusColors = {
  SELESAI: { text: "text-[#39ff14]", border: "border-[#39ff1444]", bg: "bg-[#39ff1411]" },
  "SEDANG BERJALAN": { text: "text-[#00f5ff]", border: "border-[#00f5ff44]", bg: "bg-[#00f5ff11]" },
  PROTOTIPE: { text: "text-[#bf00ff]", border: "border-[#bf00ff44]", bg: "bg-[#bf00ff11]" },
};

export default function Projects() {
  const [active, setActive] = useState<ProjectCategory | "SEMUA">("SEMUA");
  const filtered = active === "SEMUA" ? projects : projects.filter((p) => p.kategori === active);
    ...
    <section id="projects" className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        <SectionTitle
          ...
          subtitle="Proyek, riset keamanan, dan karya teknis. Tambahkan entri baru di /src/data/projects.ts"
          align="center"
          variant="cyan"
        />
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    {project.liveUrl && (
                      <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"
                        ...
                        <ExternalLink size={12} />DEMO LIVE
                      </a>
                    )}
