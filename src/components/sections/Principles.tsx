...
const principles = [
  {
    ...
    description: "Never test what you don't have permission to test. Authorization isn't optional — it's the foundation.",
    icon: "🔑",
    color: "#00f5ff",
    border: "border-[#00f5ff]",
    shadow: "shadow-[5px_5px_0_#bf00ff]",
  },
  {
    number: "02",
    title: "FINDINGS NEED EVIDENCE",
    description: "Security claims should be reproducible and documented. A finding without evidence is just a guess.",
    icon: "📋",
    color: "#bf00ff",
    border: "border-[#bf00ff]",
    shadow: "shadow-[5px_5px_0_#00f5ff]",
  },
  {
    number: "03",
    title: "RESPONSIBLE DISCLOSURE",
    description: "Report vulnerabilities responsibly. Give vendors time to fix before public disclosure.",
    icon: "🤝",
    color: "#39ff14",
  ...
  {
    number: "04",
    title: "BUILD AFTER BREAKING",
    description: "Security testing should lead to better systems — not just a list of vulnerabilities.",
    icon: "🏗️",
    color: "#00f5ff",
    border: "border-[#00f5ff]",
    shadow: "shadow-[5px_5px_0_#39ff14]",
  },
];
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        <SectionTitle
          chapter="// MY RULES"
          title="MY RULES"
          subtitle="The principles that guide every security engagement."
          align="center"
          variant="lime"
        />
